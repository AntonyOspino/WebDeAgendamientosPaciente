...
export default function DashboardClient({ initialPaciente, initialProximaCita }) {
        ...
        <div className="max-w-5xl mx-auto p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-blue-200 p-6 rounded-xl shadow-md">
              ...
              <p><strong>Tipo de Paciente:</strong> {paciente.datos_especificos.tipo_paciente}</p>
            </div>
            ...
            <div className="bg-red-200 p-6 rounded-xl shadow-md">
              ...
              <p><strong>Enfermedades:</strong> {paciente.datos_especificos.enfermedades}</p>
              <p><strong>Peso:</strong> {paciente.datos_especificos.peso} </p>
